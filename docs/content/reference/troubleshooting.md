...
Most of these come down to network reality or how jutge serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

jutge rate-limits like any public site. jutge already paces
...
Where a surface is gated, jutge reads a cookie or token you supply
...
`jutge`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what jutge actually did
